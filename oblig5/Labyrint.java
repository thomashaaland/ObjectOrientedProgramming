...
class Labyrint {
	...
	int kortestLengde = utveier.hent(0).length();
	for (String s : utveier) {
	    if (s.length() < kortestLengde) {
		kortestLengde = s.length();
		kortestVei = s;
	    }
	}
    ...
    public void leggTilUtvei(String utvei, Stabel<Rute> utveiDetaljert) {
