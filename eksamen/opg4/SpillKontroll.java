...
class SpillKontroll {
	...
	*/
	...
	VeivalgSpiller vSpiller = new VeivalgSpiller(vTerreng.hentStart(), new Terminal(new Scanner(System.in)));
	VeivalgSpiller vRobot = new VeivalgSpiller(vTerreng.hentStart(), new Robot());
	
	
	// 3. opprett og kjor Spill()
	Spill spill = new Spill(vSpiller);
	spill.spill();
